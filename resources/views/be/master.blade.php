...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('be/assets/css/custom.css') }}">
    <!-- Font Awesome CDN -->
...
<body>
    <div class="wrapper">
                            ...
                            <ul class="dropdown-menu notif-box" aria-labelledby="navbarDropdown">
                                ...
                                <li>
                                    <div class="notif-center">
                                        ...
                                        <a href="#">
                                            <div class="notif-img">
                                                <img src="{{ asset('be/assets/img/profile2.jpg') }}" alt="Img Profile">
                                            </div>
                                            <div class="notif-content">
                                                <span class="block">
                        ...
                        @if (session('loginId'))
                            ...
                            <li class="nav-item dropdown">
                                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                    aria-expanded="false"> <img src="{{ asset('fe/img/default-profile.jpg') }}"
                                        alt="user-img" width="36"
                                        class="img-circle"><span>{{ $user->name }}</span></span>
                                </a>
                                <ul class="dropdown-menu dropdown-user">
                                    <li>
                                        <div class="user-box">
                                            <div class="u-img"><img src="{{ asset('be/assets/img/profile.jpg') }}"
                                                    alt="user"></div>
                                            <div class="u-text">
                                                <h4>{{ $user->name }}</h4>
                        ...
                        @endif
                                    ...
                                    @if (session('loginId'))
                                        ...
                                        <form action="{{ route('logout') }}" method="POST">
                                            @csrf
                                            <button class="dropdown-item"><i class="fa fa-power-off"></i> Logout</button>
                                        </form>
                                    @endif
                                </ul>
                    <!-- /.dropdown-user -->
        ...
        {{-- Sidebar wrapper struktur original --}}
        <div>
            @yield('sidebar')
        </div>

        {{-- Main panel untuk content --}}
        <div class="main-panel" style="margin-left: 260px; margin-top: 55px;">
            {{-- Content area --}}
            <div class="content" style="width: 100%; min-height: calc(100vh - 55px);">
                @yield('content')
                @yield('main-content')
                @yield('content-jenis_obat')
            </div>
        </div>
    </div>
    <!-- Modal -->
...
<script src="{{ asset('be/assets/js/plugin/chartist/chartist.min.js') }}"></script>
<script src="{{ asset('be/assets/js/plugin/chartist/plugin/chartist-plugin-tooltip.min.js') }}"></script>
<script src="{{ asset('be/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js') }}"></script>
<script src="{{ asset('be/assets/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js') }}"></script>
<script src="{{ asset('be/assets/js/plugin/jquery-mapael/jquery.mapael.min.js') }}"></script>
<script src="{{ asset('be/assets/js/plugin/jquery-mapael/maps/world_countries.min.js') }}"></script>
...
<script src="{{ asset('be/assets/js/ready.min.js') }}"></script>
