    ...
    <div class="container">
        ...
        {{-- <div class="chk-steps">
            <div class="chk-step chk-step--done">
                <span class="chk-step__dot"><i class="fas fa-check"></i></span>
                <span class="chk-step__label">Keranjang</span>
            </div>
            <div class="chk-step__line"></div>
            <div class="chk-step chk-step--active">
                <span class="chk-step__dot">2</span>
                <span class="chk-step__label">Checkout</span>
            </div>
            <div class="chk-step__line"></div>
            <div class="chk-step">
                <span class="chk-step__dot">3</span>
                <span class="chk-step__label">Selesai</span>
            </div>
        </div> --}}
        ...
        <div class="chk-selects">
            <div class="chk-select-wrap">
                ...
                <div class="chk-select-field-wrap">
                    ...
                    <select class="chk-select" name="jenis_pengiriman" id="jenis_pengiriman_select" required>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    orderForm.addEventListener('submit', function (e) {
        ...
        @foreach($checkout_items as $item)
            produk.push({ id: {{ $item['id'] }}, name: "{{ $item['name'] }}", qty: {{ $item['quantity'] }}, price: {{ $item['price'] }}, image: "{{ $item['image'] }}" });
        @endforeach
